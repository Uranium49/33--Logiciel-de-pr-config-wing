...
/// <summary>Un poste de commentateur : mic + retour casque. Le talkback est toujours actif pour
/// un commentateur (mesh Companion, voir WingScenePlanner) — ce n'est pas une option ici : soit son
/// bus est perso (talkback ciblé sur lui seul), soit il partage le bus de langue (talkback commun).</summary>
public partial class CommentatorPosition : ObservableObject, IHasPhysicalInput
{
    [ObservableProperty] private string _name = string.Empty;
    [ObservableProperty] private ReturnMode _returnMode = ReturnMode.PersonalStereo;
    [ObservableProperty] private PhysicalInputRef? _physicalInput;
}
...
public partial class FieldMic : ObservableObject, IHasPhysicalInput
{
    [ObservableProperty] private string _name = string.Empty;
    [ObservableProperty] private ChannelFormat _format = ChannelFormat.Mono; // le micro lui-même (1 ou 2 entrées)
...
public partial class PcSource : ObservableObject, IHasPhysicalInput
{
    [ObservableProperty] private string _name = string.Empty;
